...
public class LocationBackgroundService extends IntentService {
        ...
        return new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                for (Location location : locationResult.getLocations()) {
                    LocationCoordinates locationCoordinates = createCoordinates(location.getLatitude(),
                            location.getLongitude(), location.getBearing(), location.getAccuracy());
    ...
    private LocationCoordinates createCoordinates(double latitude, double longitude, double bearing, double accuracy) {
