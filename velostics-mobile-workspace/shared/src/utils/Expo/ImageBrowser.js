...
import { TextButtonContainer } from '../../uikit/buttons/Button.styles';

import { TextButton } from '../../uikit/buttons/Button';
  ...
  renderHeader = () => {
    ...
    return (
      <View style={styles.header}>
        <TextButton title="imagebrowser.exit" onPress={this.props.onExit} />
        {/* <Button title="Exit" onPress={() => this.props.callback(Promise.resolve([]))} /> */}
        <Text>{headerText}</Text>
        <TextButton title="imagebrowser.choose" />
